...
const Gallery = ({ blogData, productBlog }) => {
    ...
    const blog = blogData && blogData[blogsToShow];
        ...
        <div className={classes.root}>
            <GridList className={classes.gridList}>
                <GridListTile className="flex-fill h-100" >
                    <img src={productBlog.images[0]} alt="" />
                    <GridListTileBar
                      
                        subtitle={<span style={{fontFamily:'Poppins', fontSize:'16px'}}>{productBlog && productBlog.title.rendered}</span>}
                        actionIcon={
            ...
            <div className=' w-100 py-3' style={{ backgroundColor: "#f7f7f7" }}>

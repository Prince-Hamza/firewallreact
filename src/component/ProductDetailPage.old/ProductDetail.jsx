      ...
      <section className='container sec-route my-5'>
        <Row>
          <section className='d-flex'>
            ...
            <i
              class='fa fa-chevron-right text-danger mx-2'
              aria-hidden='true'
            ></i>
            ...
            <section className='detail-img-container shadow'>
              <img
                ...
                src={
                  ...
                  productDetail.images[defaultImage].src
                }
                alt=''
              />
            </section>
          ...
          <Col className='py-4'>
            <h5 class='fw-bold' style={{ color: '#575757', fontFamily: 'Poppins', letterSpacing: '3px' }}>
              {' '}
              {productDetail.name ? productDetail?.name : productDetail?.title}
            </h5>
            ...
            <div className='mt-1 m-1 d-flex'>
              <section>
                <i className='fa mx-0 fa-star fa-md'></i>
                <i className='fa mx-0 fa-star fa-md'></i>
                <i className='fa mx-0 fa-star fa-md'></i>
                <i className='fa mx-0 fa-star fa-md'></i>
                <i className='fa mx-0 fa-star-o fa-md'></i>
              </section>
            ...
            <div>
              <i
                class='fa fa-heart fa-lg mx-1  text-muted'
                aria-hidden='true'
              ></i>
            </div>
            ...
            <div className='mt-5'>
              ...
              <h6 className='text-danger fw-bold'>
                ...
                <span className='text-danger'>Learn More</span>
              </h6>
            </div>

            <div className='mt-4 cart-button-detail'>
              <button
                className='btn w-100-resp py-2 btn-danger'
                onClick={() => addToCart(productDetail)}
              >
                <i
                  class='fa fa-lg me-2 fa-shopping-cart'
                  aria-hidden='true'
                ></i>
                Add to Cart
              </button>
              <input
                ...
                id=''
              />
              <button className='btn w-100-resp ms-3 border border-dark btn-outline-secondary py-2 px-4'>
                Bulk Quote
              </button>
            </div>

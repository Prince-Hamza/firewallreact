                ...
                <Row>
                    ...
                    <Col className="footer-2nd-col" lg={2} md={3} sm={6}>
                        <section className="mt-4">
                            ...
                            <div className="fw-light py-3 footer-padding-comp font-size text-white d-flex flex-column">
                                ...
                                <Link className="text-muted my-1" style={{ textDecorationLine: "none" }} href="javascript:void(0)" to="/solutions"><span className="text-muted my-1">Våra Tjänster</span></Link>
                                <Link className="text-muted my-1" style={{ textDecorationLine: "none" }} href="javascript:void(0)" to="/solutions"><span className="text-muted my-1">Våra Lösningar</span></Link>
                                <Link className="text-muted my-1" style={{ textDecorationLine: "none" }} href="javascript:void(0)" to="/brand"><span className="text-muted my-1">Våra Märken</span></Link>
                                <Link className="text-muted my-1" style={{ textDecorationLine: "none" }} href="javascript:void(0)" to="/resource"><span className="text-muted my-1">Våra Marken</span></Link>
                    ...
                    <Col className="footer-2nd-col" lg={2} md={3} sm={6}>
                        <section className="mt-4">
                            ...
                            <div className="fw-light footer-padding-comp py-3 font-size text-white d-flex flex-column">
                                <span className="text-muted my-1">Tekniskt Bibliotek</span>
                                <span className="text-muted my-1">Begär Offert</span>
                                <span className="text-muted my-1">Mitt Konto</span>
                                <span className="text-muted my-1">Vanliga frågor</span>
                                <span className="text-muted my-1">Allmänna Villkor</span>
                                <span className="text-muted my-1">Integritetspolicy</span>
                                <span className="text-muted my-1">Juridisk Varning</span>
                            </div>
                        </section>
                    </Col>
                    <Col className="footer-2nd-col" lg={2} md={3} sm={6}>
                    ...
                    <Col className="footer-2nd-col" lg={2} md={3} sm={6}>
                        <section className="mt-4">
                            <span style={{ borderBottom: "2px solid red" }} className="text-white pb-2 font-size h2 fw-light">Kundsupport</span>
                            <div className="fw-light footer-padding-comp py-3 font-size text-white d-flex flex-column">
                                <span className="text-muted my-1"><i class="fa fa-map-marker" style={{ marginRight: "5px" }} aria-hidden="true"></i> Svetsarvägen 15, 2tr, 17141 Solna Business Park, Stockholm Sweden</span>
                                <span className="text-muted my-3"><i class="fa fa-mobile" style={{ marginRight: "5px" }} aria-hidden="true"></i> +46 (0) 8517 082 92</span>
                                <span className="text-muted mt-3"><i class="fa fa-envelope-o" style={{ marginRight: "5px" }} aria-hidden="true"></i> sales@firewallforce.se</span>

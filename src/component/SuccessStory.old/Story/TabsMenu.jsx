        ...
        <section className="d-flex justify-content-center diamond-overflow">
            {
                objectsData.map((item, index) => {
                    return <div style={{ position: "relative" }} onClick={() => {
                        ...
                        <img src={imgArray[index]} style={{ position: "absolute", width: "55%" }} className={active === index ? "bg-danger" : "bg-dark"} alt=""  />
                    </div>
                })
            }
        </section>
            ...
            <Row>
                ...
                <Col lg={7} className="img-text-margin">
                    ...
                    <div>
                        ...
                        <p className="text-danger" style={{fontFamily: 'Poppins',fontSize: '14px'}}><input checked type="checkbox" style={{ marginRight: ".5rem" }} name="" id="" />{ddes1}</p>
                        <p style={{fontFamily: 'Poppins',fontSize: '14px', color:'#575757'}}><input checked type="checkbox" style={{ marginRight: ".5rem" }} name="" id="" />{ddes2}</p>
                        <p style={{fontFamily: 'Poppins',fontSize: '14px', color:'#575757'}}><input checked type="checkbox" style={{ marginRight: ".5rem" }} name="" id="" />{ddes3}</p>
                    </div>
                </Col>
            </Row>
        </section>
